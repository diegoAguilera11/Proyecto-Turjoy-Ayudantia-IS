...
return [
    ...
    'attributes' => [
        ...
        'number' => 'número',
        'orderMobileId' => 'identificador orden móvil',
        'password' => 'contraseña',
        ...
        'price' => 'precio',
        'province' => 'provincia',
        'products.*.quantity' => 'producto',
        'products.*.buyPrice' => 'precio de compra',
        'products.*.note' => 'nota',
        'products.*.product' => 'producto sucursal',
